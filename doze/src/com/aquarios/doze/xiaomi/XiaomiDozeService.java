...
package com.aquarios.doze.xiaomi;
...
public class XiaomiDozeService extends Service {
    ...
    private HTCProximitySensor mSensor;
    ...
    class HTCProximitySensor implements SensorEventListener {
        ...
        public HTCProximitySensor(Context context) {
    ...
    public void onCreate() {
        ...
        mSensor = new HTCProximitySensor(mContext);
        mWakeLock = mPowerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "XiaomiDozeWakeLock");
